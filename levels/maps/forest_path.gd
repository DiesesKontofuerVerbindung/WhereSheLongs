...
func _start_path_dialogue() -> void:
	...
	_show_inline_dialogue([
		...
		{"speaker": "旁白", "text": "阿麦低头看了一眼她身上的衣服。"},
		{"speaker": "阿麦", "text": "那又怎么样？"},
		{"speaker": "小凌", "text": "……"},
