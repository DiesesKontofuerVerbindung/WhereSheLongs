...
const PANEL_RECT := Rect2(302.0, 46.0, 676.0, 274.0)
const INPUT_RECT := Rect2(334.0, 152.0, 616.0, 44.0)
const BUTTON_RECT := Rect2(581.0, 241.0, 118.0, 49.0)

const PANEL_SOURCE_REGION := Rect2(302.0, 46.0, 676.0, 274.0)
const INPUT_SOURCE_REGION := Rect2(668.0, 304.0, 1232.0, 88.0)
const BUTTON_SOURCE_REGION := Rect2(1162.0, 482.0, 236.0, 98.0)
